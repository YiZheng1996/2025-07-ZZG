...
{
    public class MVBTagsBLL : BaseBLL
    {
        public MVBTagsBLL() : base(VarHelper.Database, VarHelper.ConnectionString, "FullTags")
        {

        }

        public MVBTagsBLL(string TableName) : base(VarHelper.Database, VarHelper.ConnectionString, TableName)
        {
