...
namespace MainUI.CAN
{
    public partial class ucExcelImport : UserControl
    {
        ...
        public ucExcelImport(int modelID)
        {
            InitializeComponent();
            ...
            if (OpenExcel.ShowDialog() == DialogResult.OK)
            {
                ...
                if (fileType.Contains(FileEx))
                {
                    try
                    {
                        ...
                        DataTable dt = imp.ModifyCANDataColumNmae(ExcelTable);
                        imp.InsertExcelCANDataNew(ExcelTable, modelID, "CANFullTags");
        ...
        private void GetConfigInfo()
        {
            try
            {
                ...
                string tableName = "CANFullTags";
                CANTagsBLL tags = new(tableName);
